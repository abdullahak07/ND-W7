...
const required = ['Cyber Threat War Room','Intelligence Studio theme override','Live SOC simulation','Threat Board','You are the threat modeller'];
...
console.log(`Built direct static Week 7 site (${Buffer.byteLength(html)} bytes).`);
